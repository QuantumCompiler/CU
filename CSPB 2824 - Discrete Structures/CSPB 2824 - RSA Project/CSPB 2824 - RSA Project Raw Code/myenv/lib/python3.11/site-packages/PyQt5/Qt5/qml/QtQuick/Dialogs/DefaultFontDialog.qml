...
AbstractFontDialog {
    ...
    Rectangle {
        ...
        implicitWidth: Math.min(root.__maximumDimension, Math.max(Screen.pixelDensity * 100, mainInputLayout.implicitWidth + outerSpacing * 2))
        implicitHeight: Math.min(root.__maximumDimension, Math.max(Screen.pixelDensity * 60, mainInputLayout.implicitHeight + outerSpacing * 2))
