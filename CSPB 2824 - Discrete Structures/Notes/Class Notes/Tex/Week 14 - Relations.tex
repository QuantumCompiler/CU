...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 9.1 - Relations And Their Properties.pdf}{Chapter 9.1 - Relations And Their Properties}
    \item \pdflink{\ReadMatDir Chapter 9.2 - n-ary Relations And Their Applications.pdf}{Chapter 9.2 - n-ary Relations And Their Applications}
    \item \pdflink{\ReadMatDir Chapter 9.3 - Representing Relations.pdf}{Chapter 9.3 - Representing Relations}
    \item \pdflink{\ReadMatDir Chapter 9.4 - Closures Of Relations.pdf}{Chapter 9.4 - Closures Of Relations}
    \item \pdflink{\ReadMatDir Chapter 9.5 - Equivalence Relations.pdf}{Chapter 9.5 - Equivalence Relations}
\end{itemize}
