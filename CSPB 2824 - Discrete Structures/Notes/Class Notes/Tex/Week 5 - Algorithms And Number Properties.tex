...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 2.6 - Matrices.pdf}{Chapter 2.6 - Matrices}
    \item \pdflink{\ReadMatDir Chapter 3.1 - Algorithms.pdf}{Chapter 3.1 - Algorithms}
    \item \pdflink{\ReadMatDir Chapter 3.2 - The Growth Of Functions.pdf}{Chapter 3.2 - The Growth Of Functions}
    \item \pdflink{\ReadMatDir Chapter 4.2 - Integer Representation And Algorithms.pdf}{Chapter 4.2 - Integer Representation And Algorithms}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\AssDir Assignment 5 - Algorithms And Number Properties.pdf}{Assignment 5 - Algorithms And Number Properties}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 5 - Algorithms And Matrices.pdf}{Quiz 5 - Algorithms And Matrices}
\end{itemize}
