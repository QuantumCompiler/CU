...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 10.1 - Graphs And Graph Models.pdf}{Chapter 10.1 - Graphs And Graph Models}
    \item \pdflink{\ReadMatDir Chapter 10.2 - Graph Terminology And Special Types Of Graphs.pdf}{Chapter 10.2 - Graph Terminology And Special Types Of Graphs}
\end{itemize}
