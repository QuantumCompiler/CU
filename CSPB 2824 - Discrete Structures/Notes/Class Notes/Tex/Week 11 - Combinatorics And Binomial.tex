...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 6.1 - The Basics Of Counting.pdf}{Chapter 6.1 - The Basics Of Counting}
    \item \pdflink{\ReadMatDir Chapter 6.2 - The Pigeonhole Principle.pdf}{Chapter 6.2 - The Pigeonhole Principle}
    \item \pdflink{\ReadMatDir Chapter 6.3 - Permutations And Combinations.pdf}{Chapter 6.3 - Permutations And Combinations}
    \item \pdflink{\ReadMatDir Chapter 6.4 - Binomial Coefficients And Identities.pdf}{Chapter 6.4 - Binomial Coefficients And Identities}
    \item \pdflink{\ReadMatDir Chapter 6.5 - Generalized Permutations And Combinations.pdf}{Chapter 6.5 - Generalized Permutations And Combinations}
\end{itemize}
