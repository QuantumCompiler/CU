...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 7.1 - An Introduction To Discrete Probability.pdf}{Chapter 7.1 - An Introduction To Discrete Probability}
    \item \pdflink{\ReadMatDir Chapter 7.2 - Probability Theory.pdf}{Chapter 7.2 - Probability Theory}
    \item \pdflink{\ReadMatDir Chapter 7.3 - Bayes' Theorem.pdf}{Chapter 7.3 - Bayes' Theorem}
    \item \pdflink{\ReadMatDir Chapter 7.4 - Expected Value And Variance.pdf}{Chapter 7.4 - Expected Value And Variance}
\end{itemize}
