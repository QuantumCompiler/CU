...
The assignment for this week is \pdflink{\AssDir Assignment 6 - Number Theory And Primes.pdf}{Assignment 6 - Number Theory And Primes} \due{(10/16/23)} \cbox{assignment-week7}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51708}{Number Theory And Primes} \textbullet \pdflink{\QuizDir Quiz 6 - Number Theory And Primes.pdf}{Quiz 6 - Number Theory And Primes} \due{(10/16/23)} \cbox{quiz-week7}
