...
Must post / respond to at least \textbf{two} Piazza posts this week. \due{(12/15/23)} \cbox{piazza-week16}
...
\begin{itemize}
    \item \pdflink{./Notes/Essential Graph Theory Lecture Notes.pdf}{Essential Graph Theory Lecture Notes}
    \item \pdflink{./Notes/Connectedness And Eulerian Tours Lecture Notes.pdf}{Connectedness And Eulerian Tours Lecture Notes}
    \item \pdflink{./Notes/The Coloring Problem Lecture Notes.pdf}{The Coloring Problem Lecture Notes}
\end{itemize}

\subsection{Assignments}

The assignment for this week is \pdflink{./Assignments/Graphs Mastery Workbook.pdf}{Graphs Mastery Workbook}.
