...
The assignment for this week is \pdflink{\AssDir Assignment 4 - Sets And Functions.pdf}{Assignment 4 - Sets And Functions} \due{(9/25/23)} \cbox{assignment-week4}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51619}{Sets And Functions} \textbullet \pdflink{\QuizDir Quiz 4 - Sets And Modulo.pdf}{Quiz 4 - Sets And Modulo} \due{(9/25/23)} \cbox{quiz-week4}
