...
Must post / respond to at least \textbf{two} Piazza posts this week. \due{(9/22/23)} \cbox{piazza-week4}
...
\begin{itemize}
    \item \pdflink{./Notes/Algorithms Lecture Notes.pdf}{Algorithms}
    \item \pdflink{./Notes/Countable And Uncountable Sets Lecture Notes.pdf}{Countable And Uncountable Sets}
    \item \pdflink{./Notes/Functions Lecture Notes.pdf}{Functions}
    \item \pdflink{./Notes/Modular Scoops Lecture Notes.pdf}{Modular Scoops}
    \item \pdflink{./Notes/Sets And Set Operations Lecture Notes.pdf}{Sets And Set Operations}
\end{itemize}

\subsection{Assignments}

The assignment for this week is \pdflink{./Assignments/Sets And Functions Mastery Workbook.pdf}{Sets And Functions} \due{(9/25/23)} \cbox{assignment-week4}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51619}{Sets And Functions} \due{(9/25/23)} \cbox{quiz-week4}
