...
The assignment for this week is \pdflink{\AssDir Assignment 1 - Logic And Reasoning.pdf}{Assignment 1 - Logic And Reasoning} \due{(9/5/23)} \cbox{assignment-week1}
...
\begin{itemize}
    \item \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51560}{Logic And Reasoning} \textbullet \pdflink{\QuizDir Quiz 1 - Logic And Reasoning.pdf}{Quiz 1 - Logic And Reasoning} \due{(9/5/23)} \cbox{quiz-week1}
