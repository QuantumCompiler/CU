...
Must post / respond to at least \textbf{two} Piazza posts this week. \due{(9/1/23)} \cbox{piazza-week1}
...
\begin{itemize}
    \item \pdflink{./Notes/Conditionals And Biconditionals Lecture Notes.pdf}{Conditionals And Biconditionals}
    \item \pdflink{./Notes/Conjuctions And Disjunctions Lecture Notes.pdf}{Conjunctions And Disjunctions}
    \item \href{https://www.stumblingrobot.com/2015/06/29/prove-consequences-of-the-field-axioms/}{Field Axiom Proofs}
\end{itemize}

\subsection{Assignments}

The assignment for this week is \pdflink{./Assignments/Logic And Reasoning Mastery Workbook.pdf}{Logic And Reasoning.} \due{(9/5/23)} \cbox{assignment-week1}
...
\begin{itemize}
    \item \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51560}{Logic And Reasoning} \due{(9/5/23)} \cbox{quiz-week1}
    \item \href{https://www.dictionary.com/games/quizzes/is-it-inductive-or-deductive-a-reasoning-challenge}{Inductive Vs. Deductive Reasoning} \due{(OPTIONAL)} \cbox{opquiz1-week1}
    \item \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51556}{Algebra Reading Quiz} \due{(OPTIONAL)} \cbox{opquiz2-week1}
\end{itemize}
