...
The assignment for this week is \pdflink{\AssDir Assignment 7 - Cryptography.pdf}{Assignment 7 - Cryptography} \due{(10/23/23)} \cbox{assignment-week8}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51735}{Cryptography} \textbullet \pdflink{\QuizDir Quiz 7 - Cryptography.pdf}{Quiz 7 - Cryptography} \due{(10/23/23)} \cbox{quiz-week8}
