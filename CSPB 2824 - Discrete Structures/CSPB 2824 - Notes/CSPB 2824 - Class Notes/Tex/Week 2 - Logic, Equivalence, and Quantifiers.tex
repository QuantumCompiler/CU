...
\begin{itemize}
    \item \pdflink{./Notes/Propositional Equivalence Lecture Notes.pdf}{Propositional Equivalence}
    \item \pdflink{./Notes/Predicates And Quantifiers Lecture Notes.pdf}{Predicates And Quantifiers}
    \item \pdflink{./Notes/Nested Quantifiers Lecture Notes.pdf}{Nested Quantifiers}
\end{itemize}

\subsection{Assignments}

The assignment for this week is \pdflink{./Assignments/Propositional Logic Mastery Workbook.pdf}{Propositional Logic Mastery Workbook.} \due{(9/11/23)} \cbox{assignment-week2}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51574}{Predicates And Quantifiers.} \due{(9/11/23)} \cbox{quiz-week2}
