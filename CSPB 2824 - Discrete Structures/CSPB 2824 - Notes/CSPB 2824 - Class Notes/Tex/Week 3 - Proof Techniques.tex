...
The assignment for this week is \pdflink{\AssDir Assignment 2 - Propositional Logic.pdf}{Assignment 2 - Propositional Logic} \due{(9/18/23)} \cbox{assignment-week3}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51597}{Proof Techniques} \textbullet \pdflink{\QuizDir Quiz 3 - Proof techniques.pdf}{Quiz 3 - Proof techniques} \due{(9/18/23)} \cbox{quiz-week3}
