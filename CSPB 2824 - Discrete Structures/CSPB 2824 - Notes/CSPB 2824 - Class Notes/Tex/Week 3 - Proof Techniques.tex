...
Must post / respond to at least \textbf{two} Piazza posts this week. \due{(9/15/23)} \cbox{piazza-week3}
...
\begin{itemize}
    \item \pdflink{./Notes/Algebra And Log Rule Review Lecture Notes.pdf}{Algebra And Log Rule Review}
    \item \pdflink{./Notes/Proof Tutorial Lecture Notes.pdf}{Proof Tutorial}
    \item \pdflink{./Notes/Rosen Proofs Lecture Notes.pdf}{Rosen Proofs}
\end{itemize}

\subsection{Assignments}

The assignment for this week is \pdflink{./Assignments/Proof Techniques Mastery Workbook.pdf}{Proof Techniques Mastery Workbook} \due{(9/18/23)} \cbox{assignment-week3}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51597}{Proof Techniques} \due{(9/18/23)} \cbox{quiz-week3}
