...
The assignment for this week is \pdflink{./Assignments/Induction Mastery Workbook.pdf}{Induction} \due{(11/6/23)} \cbox{assignment-week10}

\subsection{Quiz}

The quiz's for this week can be found at \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=51773}{Induction} \due{(11/6/23)} \cbox{quiz-week10}
