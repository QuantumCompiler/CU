...
class MyCanvas (val listOfObjects: List[Figure]) {
    ...
    */
    def placeRight(myc2: MyCanvas): MyCanvas = {
        val x = getBoundingBox._2 - getBoundingBox._1
        val y = ((getBoundingBox._4 - getBoundingBox._3) / 2) - ((myc2.getBoundingBox._4 - myc2.getBoundingBox._3) / 2)
        overlap(myc2.translate(x,y))
    }
    ...
    */
    def placeTop(myc2: MyCanvas): MyCanvas = {
        val x = ((getBoundingBox._4 - getBoundingBox._3) / 2) - ((myc2.getBoundingBox._4 - myc2.getBoundingBox._3) / 2)
        val y = getBoundingBox._2 - getBoundingBox._1
        overlap(myc2.translate(x,y))
    }
