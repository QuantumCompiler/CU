...
\begin{itemize}
    \item The assignment for this week is \href{https://github.com/QuantumCompiler/CU/tree/main/CSPB%203104%20-%20Algorithms/CSPB%203104%20-%20Assignments/CSPB%203104%20-%20Problem%20Sets/CSPB%203104%20-%20Problem%20Set%206%20-%20Dynamic%20Programming}{Problem Set 6 - Dynamic Programming}. \assignment{3/7/24}{Ass6DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55649}{Quiz 6} \textbullet \pdflink{\QuizDir Quiz 6.pdf}{Finalized Quiz 6} \assignment{2/26/24}{Quiz6DueDate}
\end{itemize}
