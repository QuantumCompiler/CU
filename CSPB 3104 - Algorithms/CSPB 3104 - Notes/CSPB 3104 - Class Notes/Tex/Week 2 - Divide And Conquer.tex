...
\begin{itemize}
    \item The assignment for this week is \textbf{Divide And Conquer}. \assignment{2/1/24}{Ass2DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55596}{Quiz 2} \textbullet \pdflink{\QuizDir CSPB 3104 Quiz 2.pdf}{Finalized Quiz 2} \assignment{1/29/24}{Quiz2DueDate}
\end{itemize}
