...
Must post / respond to two Piazza posts. \assignment{3/19/24}{Piazza8DueDate}
...
\begin{itemize}
    \item The assignment for this week is \textbf{Problem Set 7 - Graphs}. \assignment{3/21/24}{Ass8DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55677}{Quiz 8} \textbullet \pdflink{\QuizDir CSPB 3104 Quiz 8.pdf}{Finalized Quiz 8} \assignment{3/18/24}{Quiz8DueDate}
\end{itemize}
