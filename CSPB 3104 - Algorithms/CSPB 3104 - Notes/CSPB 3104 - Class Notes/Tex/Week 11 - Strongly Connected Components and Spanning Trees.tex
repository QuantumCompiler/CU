...
\begin{itemize}
    \item The assignment for this week is \href{https://github.com/QuantumCompiler/CU/tree/main/CSPB%203104%20-%20Algorithms/CSPB%203104%20-%20Assignments/CSPB%203104%20-%20Problem%20Sets/CSPB%203104%20-%20Problem%20Set%208%20-%20Strongly%20Connected%20Components%20And%20Spanning%20Trees}{Problem Set 8 - Strongly Connected Components and Spanning Trees}. \assignment{4/11/24}{Ass9DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55691}{Quiz 9} \textbullet \pdflink{\QuizDir Quiz 9.pdf}{Finalized Quiz 9} \assignment{4/8/24}{Quiz9DueDate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55696}{Exam 3} \assignment{4/2/24}{Exam3DueDate}
