...
\begin{itemize}
    \item The first assignment for this week is \textbf{Problem Set 3 - Heaps And Quicksort}. \assignment{2/8/24}{Ass3aDueDate}
    \item The second assignment for this week is \textbf{Programming Assignment - Heaps And Quicksort}. \assignment{2/8/24}{Ass3bDueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55609}{Quiz 3} \textbullet \pdflink{\QuizDir CSPB 3104 Quiz 3.pdf}{Finalized Quiz 3} \assignment{2/6/24}{Quiz3DueDate}
\end{itemize}
