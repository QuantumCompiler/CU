...
Must post / respond to two Piazza posts. \assignment{3/12/24}{Piazza7DueDate}
...
\begin{itemize}
    \item The assignment for this week is \textbf{Programming Assignment 2 - Tries}. \assignment{4/1/24}{ProgAss2DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55666}{Quiz 7} \textbullet \pdflink{\QuizDir CSPB 3104 Quiz 7.pdf}{Finalized Quiz 7} \assignment{3/11/24}{Quiz7DueDate}
\end{itemize}
