...
\renewcommand{\ChapTitle}{Week 12: (4/8 - 4/14)}
...
Must post / respond to two Piazza posts. \assignment{4/16/24}{Piazza12DueDate}
...
\begin{itemize}
    \item The assignment for this week is \textbf{Problem Set 9 - Shortest Path Algorithms}. \assignment{4/18/24}{Ass9DueDate}
    \item The assignment for this week is \textbf{Programming Assignment 3 - Shortest Path}. \assignment{5/3/24}{ProgAss3DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=55708}{Quiz 10} \textbullet \pdflink{\QuizDir CSPB 3104 Quiz 10.pdf}{Finalized Quiz 10} \assignment{4/15/24}{Quiz10DueDate}
\end{itemize}
