...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 22.5 - Strongly Connected Components.pdf}{Chapter 22.5 - Strongly Connected Components}
    \item \pdflink{\ReadMatDir Chapter 23.1 - Growing A Minimum Spanning Tree.pdf}{Chapter 23.1 - Growing A Minimum Spanning Tree}
    \item \pdflink{\ReadMatDir Chapter 23.2 - The Algorithms Of Kurskal And Prim.pdf}{Chapter 23.2 - The Algorithms Of Kurskal And Prim}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 9.pdf}{Quiz 9}
\end{itemize}
