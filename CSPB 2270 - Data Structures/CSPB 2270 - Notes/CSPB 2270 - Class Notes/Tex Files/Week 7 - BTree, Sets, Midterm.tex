...
\end{itemize}
The lecture notes for this week are \pdflink{\LectureNotesDir Design & B-Trees Lecture Notes.pdf}{Design \& B-Trees Lecture Notes}.
...
The notes for the exam this week are \pdflink{\ExamNotesDir Exam 1 Notes.pdf}{Exam 1 Notes}. The finalized exam is \pdflink{\ExamDir Exam 1.pdf}{Exam 1}.
...
\begin{notes}{Section 11.1 - B-Trees}
    ...
    \begin{highlight}[B-Trees Example]
...
\begin{notes}{Section 11.2 - 2-3-4 B-Tree Search Algorithm}
    ...
    \begin{highlight}[2-3-4 B-Tree Search Algorithm Example]
...
\begin{notes}{Section 11.3 - 2-3-4 B-Tree Insert Algorithm}
    ...
    \begin{highlight}[2-3-4 B-Tree Insert Algorithm Example]
...
\begin{notes}{Section 11.4 - 2-3-4 B-Tree Rotations \& Fusion}
    ...
    \begin{highlight}[2-3-4 B-Tree Rotation Example]
    ...
    \begin{highlight}[2-3-4 B-Tree Fusion Example]
...
\begin{notes}{Section 11.5 - 2-3-4 Tree Removal}
    ...
    \begin{highlight}[2-3-4 B-Tree Merge Algorithm Example]
    ...
    \begin{highlight}[2-3-4 Remove Algorithm Example]
...
\begin{notes}{Section 12.1 - Set Abstract Data Type}
...
\begin{notes}{Section 12.2 - Set Operations}
    ...
    \begin{highlight}[Set Operations Example]
...
\begin{notes}{Section 12.3 - Static \& Dynamic Set Operations}
    ...
    \begin{highlight}[Static \& Dynamic Set Operations Example]
