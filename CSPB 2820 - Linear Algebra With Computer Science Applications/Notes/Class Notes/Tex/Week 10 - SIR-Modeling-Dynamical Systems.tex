...
\begin{itemize}
    \item \pdflink{\ReadMatDir VMLS Chapter 9.1 - Linear Dynamical Systems.pdf}{VMLS Chapter 9.1 - Linear Dynamical Systems}
    \item \pdflink{\ReadMatDir VMLS Chapter 9.2 - Population Dynamics.pdf}{VMLS Chapter 9.2 - Population Dynamics}
    \item \pdflink{\ReadMatDir VMLS Chapter 9.3 - Epidemic Dynamics.pdf}{VMLS Chapter 9.3 - Epidemic Dynamics}
    \item \pdflink{\ReadMatDir VMLS Chapter 9.4 - Motion Of A Mass.pdf}{VMLS Chapter 9.4 - Motion Of A Mass}
    \item \pdflink{\ReadMatDir VMLS Chapter 9.5 - Supply Chain Dynamics.pdf}{VMLS Chapter 9.5 - Supply Chain Dynamics}
    \item \pdflink{\ReadMatDir Python Companion Chapter 9.1 - Linear Dynamical Systems.pdf}{Python Companion Chapter 9.1 - Linear Dynamical Systems}
    \item \pdflink{\ReadMatDir Python Companion Chapter 9.2 - Population Dynamics.pdf}{Python Companion Chapter 9.2 - Population Dynamics}
    \item \pdflink{\ReadMatDir Python Companion Chapter 9.3 - Epidemic Dynamics.pdf}{Python Companion Chapter 9.3 - Epidemic Dynamics}
    \item \pdflink{\ReadMatDir Python Companion Chapter 9.4 - Motion Of A Mass.pdf}{Python Companion Chapter 9.4 - Motion Of A Mass}
    \item \pdflink{\ReadMatDir Python Companion Chapter 9.5 - Supply Chain Dynamics.pdf}{Python Companion Chapter 9.5 - Supply Chain Dynamics}
\end{itemize}
