...
Must post / respond to at least \textbf{four} Piazza posts this week. \due{(10/27/23)} \cbox{piazza-week9}
...
The assignment for this week is \pdflink{\AssDir Assignment 8 - Linear Equations.pdf}{Assignment 8 - Linear Equations} \due{(10/30/23)} \cbox{assignment-week9}

\subsection{Quiz}

The quiz for this week is \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=50764}{Chapter 8} \textbullet \pdflink{\QuizDir Quiz 8 - Linear Equations.pdf}{Quiz 8 - Linear Equations} \due{(10/30/23)} \cbox{quiz-week9}
