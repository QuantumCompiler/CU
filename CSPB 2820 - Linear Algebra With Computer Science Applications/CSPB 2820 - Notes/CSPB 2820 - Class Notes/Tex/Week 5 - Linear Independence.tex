...
\begin{itemize}
    ...
    \item \pdflink{\ReadMatDir VMLS Chapter 5.1 - Linear Dependence.pdf}{VMLS Chapter 5.1 - Linear Dependence}
    \item \pdflink{\ReadMatDir VMLS Chapter 5.2 - Basis.pdf}{VMLS Chapter 5.2 - Basis}
    \item \pdflink{\ReadMatDir VMLS Chapter 5.3 - Orthonormal Vectors.pdf}{VMLS Chapter 5.3 - Orthonormal Vectors}
    \item \pdflink{\ReadMatDir VMLS Chapter 5.4 - Gram-Schmidt Algorithm.pdf}{VMLS Chapter 5.4 - Gram-Schmidt Algorithm}
    \item \pdflink{\ReadMatDir Python Companion Chapter 5.1 - Linear Independence.pdf}{Python Companion Chapter 5.1 - Linear Independence}
    \item \pdflink{\ReadMatDir Python Companion Chapter 5.2 - Basis.pdf}{Python Companion Chapter 5.2 - Basis}
    \item \pdflink{\ReadMatDir Python Companion Chapter 5.3 - Orthonormal Vectors.pdf}{Python Companion Chapter 5.3 - Orthonormal Vectors}
    \item \pdflink{\ReadMatDir Python Companion Chapter 5.4 - Gram-Schmidt Algorithm.pdf}{Python Companion Chapter 5.4 - Gram-Schmidt Algorithm}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\AssDir Assignment 5 - Linear Independence.pdf}{Assignment 5 - Linear Independence}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 5 - Linear Independence.pdf}{Quiz 5 - Linear Independence}
\end{itemize}
