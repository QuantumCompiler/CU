...
The assignment for this week is \pdflink{./Assignments/VMLS Assignment 3 - Chapter 3.pdf}{VMLS - Assignment 3: Chapter 3.} \due{(9/18/23)} \cbox{assignment-week3}

\subsection{Quiz}

The quiz for this week is \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=50699}{Chapter 3.} \due{(9/18/23)} \cbox{quiz-week3}
