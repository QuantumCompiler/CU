...
\begin{itemize}
    \item \pdflink{\ReadMatDir VMLS Chapter 2.1 - Linear Functions.pdf}{VMLS Chapter 2.1 - Linear Functions}
    \item \pdflink{\ReadMatDir VMLS Chapter 2.2 - Taylor Approximations.pdf}{VMLS Chapter 2.2 - Taylor Approximations}
    \item \pdflink{\ReadMatDir VMLS Chapter 2.3 - Regression Model.pdf}{VMLS Chapter 2.3 - Regression Model}
    \item \pdflink{\ReadMatDir Python Companion Chapter 2.1 - Linear Functions.pdf}{Python Companion Chapter 2.1 - Linear Functions}
    \item \pdflink{\ReadMatDir Python Companion Chapter 2.2 - Taylor Approximation.pdf}{Python Companion Chapter 2.2 - Taylor Approximation}
    \item \pdflink{\ReadMatDir Python Companion Chapter 2.3 - Regression Model.pdf}{Python Companion Chapter 2.3 - Regression Model}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\AssDir Assignment 2 - Linear Functions.pdf}{Assignment 2 - Linear Functions}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 2 - Linear Functions.pdf}{Quiz 2 - Linear Functions}
\end{itemize}
