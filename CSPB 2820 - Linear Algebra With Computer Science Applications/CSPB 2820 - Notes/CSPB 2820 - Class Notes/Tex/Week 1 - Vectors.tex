...
The assignment for this week is \pdflink{./Assignments/VMLS Assignment 1 - Chapter 1.pdf}{VMLS - Assignment 1: Chapter 1.} \due{(9/5/23)} \cbox{assignment-week1}

\subsection{Quiz}

The quiz for this week is \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=50674}{Chapter 1.} \due{(9/5/23)} \cbox{quiz-week1}
