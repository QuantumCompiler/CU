...
The assignment for this week is \pdflink{./Assignments/VMLS Assignment 4 - Chapter 4.pdf}{VMLS - Assignment 4: Chapter 4.} \due{(9/25/23)} \cbox{assignment-week4}

\subsection{Quiz}

The quiz for this week is \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=50706}{Chapter 4.} \due{(9/25/23)} \cbox{quiz-week4}
