...
The assignment for this week is \pdflink{\AssDir Assignment 11 - Matrix Inverses.pdf}{Assignment 11 - Matrix Inverses} \due{(11/20/23)} \cbox{assignment-week12}

\subsection{Quiz}

The quiz for this week is \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=50812}{Chapter 11} \textbullet \pdflink{\QuizDir Quiz 11 - Matrix Inverses.pdf}{Quiz 11 - Matrix Inverses} \due{(11/20/23)} \cbox{quiz-week12}
