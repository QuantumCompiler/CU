...
\renewcommand{\ChapTitle}{Expected Value, Variance - Discrete And Continuous RV}
...
\begin{itemize}
    ...
    \item \pdflink{\LecNoteDir More With RV - Discrete Versus Continuous - Expected Value And Variance Lecture Notes.pdf}{More With RV - Discrete Vs. Continuous - Expected Value And Variance Lecture Notes}
