...
Piazza discussions are optional this week. \assignment{1/23/24}{PiazzaWeek1}
...
\begin{itemize}
    \item \pdflink{\LecNoteDir Course Overview Lecture Notes.pdf}{Course Overview}
    \item \pdflink{\LecNoteDir Bits And Bytes Lecture Notes.pdf}{Bits And Bytes}
    \item \pdflink{\LecNoteDir Strings and Memory Representations Lecture Notes.pdf}{Strings and Memory Representations}
    \item \pdflink{\LecNoteDir Integer Representation Lecture Notes.pdf}{Integer Representation}
