...
Piazza discussions are optional this week. \assignment{4/16/24}{PiazzaWeek12}
...
\begin{itemize}
    \item \href{https://github.com/cu-cspb-2400-fall-2023/lab5-shelllab-QuantumCompiler}{Shell Lab} \assignment{4/23/24}{Ass5DueDate}
    \item \href{https://applied.cs.colorado.edu/mod/scheduler/view.php?id=53286}{Shell Lab Interview} \assignment{4/23/24}{Ass5DueDate}
\end{itemize}
...
\begin{itemize}
    ...
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=53305}{Exam 3} \textbullet \pdflink{\ExamDir Exam 3 - Making Programs Run Really Fast.pdf}{Exam 3 - Making Programs Run Really Fast} \assignment{4/10/24}{Exam3DueDate}
\end{itemize}
