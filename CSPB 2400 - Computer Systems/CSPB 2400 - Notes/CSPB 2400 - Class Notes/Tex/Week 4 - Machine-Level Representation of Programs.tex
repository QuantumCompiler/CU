...
\begin{itemize}
    \item Computer Systems: Chapter 3.6
    \item Computer Systems: Chapter 3.7
\end{itemize}

\subsection{Piazza}

Piazza discussions are optional this week. \assignment{2/13/24}{PiazzaWeek4}
...
\begin{itemize}
    \item \href{https://github.com/cu-cspb-2400-fall-2023/lab2-bomblab-QuantumCompiler}{Bomb Lab} \assignment{2/20/24}{Ass2DueDate}
    \item \href{https://github.com/cu-cspb-2400-fall-2023/lab2-bomblab-QuantumCompiler}{Bomb Lab Extra Credit} \assignment{2/20/24}{Ass2DueDate}
    \item \href{https://applied.cs.colorado.edu/mod/scheduler/view.php?id=53208}{Bomb Lab Interview} \assignment{2/20/24}{Ass2DueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=53226}{Chapter 3.6 Quiz} \textbullet \pdflink{\QuizDir CSPB 2400 Quiz 4a.pdf}{Chapter 3.6 Finalized Quiz} \assignment{2/13/24}{Quiz4aDueDate}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=53227}{Chapter 3.7 Quiz} \textbullet \pdflink{\QuizDir CSPB 2400 Quiz 4b.pdf}{Chapter 3.7 Finalized Quiz} \assignment{2/13/24}{Quiz4bDueDate}
\end{itemize}
...
\begin{itemize}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=53211}{Practice Exam 1}
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=53229}{Exam 1} \textbullet \pdflink{\ExamDir Exam 1 - Data Representation.pdf}{Exam 1 - Data Representation} \assignment{2/7/24}{Exam1DueDate}
\end{itemize}
