...
Piazza discussions are optional this week. \assignment{3/5/24}{PiazzaWeek7}
...
\begin{itemize}
    ...
    \item \link{https://applied.cs.colorado.edu/mod/quiz/view.php?id=53263}{Exam 2} \textbullet \pdflink{\ExamDir Exam 2 - Machine Level Representation.pdf}{Exam 2 - Machine Level Representation} \assignment{2/28/24}{Exam2DueDate}
\end{itemize}
