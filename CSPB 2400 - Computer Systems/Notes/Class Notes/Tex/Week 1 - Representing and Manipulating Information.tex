...
\begin{itemize}
    \item \textbf{Chapter 1 - A Tour Of Computer Systems}
    \item \textbf{Chapter 2.1 - Information Storage}
    \item \textbf{Chapter 2.2 - Integer Representations}
    \item \textbf{Chapter 2.3 - Integer Arithmetic}
\end{itemize}
