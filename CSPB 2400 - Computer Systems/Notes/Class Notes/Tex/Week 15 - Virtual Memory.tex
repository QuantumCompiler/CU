...
\begin{itemize}
    ...
    \item \pdflink{\ReadingMatDir Chapter 9.8 - Memory Mapping.pdf}{Chapter 9.8 - Memory Mapping}
    \item \pdflink{\ReadingMatDir Chapter 9.9 - Dynamic Memory Allocation.pdf}{Chapter 9.9 - Dynamic Memory Allocation}
    \item \pdflink{\ReadingMatDir Chapter 9.10 - Garbage Collection.pdf}{Chapter 9.10 - Garbage Collection}
    \item \pdflink{\ReadingMatDir Chapter 9.11 - Common Memory-Related Bugs In C Programs.pdf}{Chapter 9.11 - Common Memory-Related Bugs In C Programs}
\end{itemize}
