...
\begin{itemize}
    \item \textbf{Chapter 6.1 - Storage Technologies}
    \item \textbf{Chapter 6.2 - Locality}
    \item \textbf{Chapter 6.3 - The Memory Hierarchy}
    \item \textbf{Chapter 6.4 - Cache Memories}
    \item \textbf{Chapter 6.5 - Writing Cache-Friendly Code}
    \item \textbf{Chapter 6.6 - Putting It Together - The Impact Of Caches On Program Performance}
\end{itemize}
