...
# Imports
# The solutions for the operations can use the regular expression library 
import re
...
###############################################################################
# Public Classes
#   The CharacterCounter class will be given a string during creation
...
class CharacterCounter:
    ...
    #   is used to reference the object being constructed.  It is automatically
    ...
    def __init__(self, given_text):
        ...
        if not isinstance(given_text, str):
    ...
    # The given implementation just calls the built-in function described above.
    #
    def count(self):
        """
    ...
    def is_phonenumber(self):
        ...
        phonenum = re.compile(r'^[2-9][0-8][0-9]-[2-9][0-9]{2}-[0-9]{4}$')
