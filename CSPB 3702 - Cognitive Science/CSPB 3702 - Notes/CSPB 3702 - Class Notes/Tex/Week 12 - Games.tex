...
\begin{itemize}
    \item \pdflink{\ReadingMatDir The Evolution Of Institutions For Collective Action.pdf}{The Evolution Of Institutions For Collective Action}
\end{itemize}
...
The assignment for this week is \pdflink{\AssDir Assignment 4 - Making A Teachable Machine.pdf}{Assignment 4 - Making A Teachable Machine} \due{(12/1/23)} \cbox{minproj4}
