...
\begin{itemize}
    \item \pdflink{./Reading Material/Recognizing, Defining, and Representing Problems.pdf}{Recognizing, Defining, and Representing Problems}
\end{itemize}

\subsection{Piazza}

Must post / respond to at least \textbf{five} Piazza posts this week. \due{(9/22/23)} \cbox{piazza-week4}
...
\begin{itemize}
    \item \pdflink{./Lecture Notes/Problem Solving Lecture Notes.pdf}{Problem Solving}
\end{itemize}
...
\begin{itemize}
    \item \href{https://applied.cs.colorado.edu/mod/quiz/view.php?id=49353}{Problem Solving} \due{(9/25/23)} \cbox{quiz-week4}
\end{itemize}
