...
\begin{itemize}
    \item \pdflink{\ReadingMatDir Judgement Under Uncertainty - Heuristics And Biases.pdf}{Judgement Under Uncertainty - Heuristics And Biases}
    \item \pdflink{\ReadingMatDir Prospect Theory.pdf}{Prospect Theory}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\LectNotesDir Heuristics Lecture Notes.pdf}{Heuristics Lecture Notes}
\end{itemize}
...
\begin{itemize}
    ...
    \item \pdflink{\QuizDir Quiz 4 - Problem Solving 2B.pdf}{Quiz 4 - Problem Solving 2B}
\end{itemize}
