...
\begin{itemize}
    \item \pdflink{\ReadingMatDir Computing Machinery And Intelligence.pdf}{Computing Machinery And Intelligence}
    \item \pdflink{\ReadingMatDir Minds, Brains, And Programs.pdf}{Minds, Brains, And Programs}
\end{itemize}
...
The assignment for this week is \pdflink{\AssDir Assignment 1 - Digital Automata.pdf}{Assignment 1 - Digital Automata}. \due{(9/15/23)} \cbox{minproj1}
