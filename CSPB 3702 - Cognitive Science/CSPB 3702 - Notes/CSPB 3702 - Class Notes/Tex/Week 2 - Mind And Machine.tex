...
\begin{itemize}
    \item \pdflink{\ReadingMatDir The Nature of Mental States.pdf}{The Nature of Mental States}
\end{itemize}
...
The assignment for this week is \pdflink{\AssDir Assignment 1 - Digital Automata.pdf}{Assignment 1 - Digital Automata}. \due{(9/15/23)} \cbox{minproj2}
