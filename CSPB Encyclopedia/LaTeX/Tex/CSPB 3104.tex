...
The syllabus for this course can be found below: \coursedoc{\pdflink{\CSPBAlgoSyllabusDir CSPB 3104 - Algorithms Syllabus.pdf}{CSPB 3104 - Algorithms Syllabus}}

\subsection{Course Textbook}

The textbooks for this course can be found below:

\coursedoc{\pdflink{\CSPBAlgoTextbookDir Grokking Algorithms An Illustrated Guide for Programmers and Other Curious People (First Edition) - Aditya Bhargava.pdf}{\footnotesize{{Grokking Algorithms An Illustrated Guide for Programmers and Other Curious People (First Edition) - Aditya Bhargava}}}}

\coursedoc{\pdflink{\CSPBAlgoTextbookDir Introduction to Algorithms (Third Edition) - Cormen, Thomas H. Leiserson, Charles E. Rivest, Ronald L. Stein.pdf}{\footnotesize{{Introduction to Algorithms (Third Edition) - Cormen, Thomas H. Leiserson, Charles E. Rivest, Ronald L. Stein}}}}