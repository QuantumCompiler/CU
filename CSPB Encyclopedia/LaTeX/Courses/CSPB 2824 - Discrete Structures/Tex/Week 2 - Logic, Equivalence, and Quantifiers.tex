...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 1.3 - Propositional Equivalences.pdf}{Chapter 1.3 - Propositional Equivalences}
    \item \pdflink{\ReadMatDir Chapter 1.4 - Predicates And Quantifiers.pdf}{Chapter 1.4 - Predicates And Quantifiers}
    \item \pdflink{\ReadMatDir Chapter 1.5 - Nested Quantifiers.pdf}{Chapter 1.5 - Nested Quantifiers}
    \item \pdflink{\ReadMatDir Chapter 1.6 - Rules Of Inference.pdf}{Chapter 1.6 - Rules Of Inference}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 2 - Predicates and Quantifiers.pdf}{Quiz 2 - Predicates and Quantifiers}
\end{itemize}
