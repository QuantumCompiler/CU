...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 2.4 - Sequences And Summations.pdf}{Chapter 2.4 - Sequences And Summations}
    \item \pdflink{\ReadMatDir Chapter 5.1 - Mathematical Induction.pdf}{Chapter 5.1 - Mathematical Induction}
    \item \pdflink{\ReadMatDir Chapter 5.4 - Recursive Algorithms.pdf}{Chapter 5.4 - Recursive Algorithms}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\AssDir Assignment 8 - Induction.pdf}{Assignment 8 - Induction}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 9 - Induction.pdf}{Quiz 9 - Induction}
\end{itemize}
