...
\begin{itemize}
    ...
    \item \pdflink{\ReadMatDir VMLS Chapter 4.1 - Clustering.pdf}{VMLS Chapter 4.1 - Clustering}
    \item \pdflink{\ReadMatDir VMLS Chapter 4.2 - A Clustering Objective.pdf}{VMLS Chapter 4.2 - A Clustering Objective}
    \item \pdflink{\ReadMatDir VMLS Chapter 4.3 - The K-Means Algorithm.pdf}{VMLS Chapter 4.3 - The K-Means Algorithm}
    \item \pdflink{\ReadMatDir VMLS Chapter 4.4 - Examples.pdf}{VMLS Chapter 4.4 - Examples}
    \item \pdflink{\ReadMatDir VMLS Chapter 4.5 - Applications.pdf}{VMLS Chapter 4.5 - Applications}
    \item \pdflink{\ReadMatDir Python Companion Chapter 4.1 - Clustering.pdf}{Python Companion Chapter 4.1 - Clustering}
    \item \pdflink{\ReadMatDir Python Companion Chapter 4.2 - A Clustering Objective.pdf}{Python Companion Chapter 4.2 - A Clustering Objective}
    \item \pdflink{\ReadMatDir Python Companion Chapter 4.3 - The K-Means Algorithm.pdf}{Python Companion Chapter 4.3 - The K-Means Algorithm}
    \item \pdflink{\ReadMatDir Python Companion Chapter 4.4 - Examples.pdf}{Python Companion Chapter 4.4 - Examples}
    \item \pdflink{\ReadMatDir Python Companion Chapter 4.5 - Applications.pdf}{Python Companion Chapter 4.5 - Applications}
\end{itemize}
