...
\begin{itemize}
    ...
    \item \pdflink{\ReadMatDir VMLS Chapter 10.1 - Matrix-Matrix Multiplication.pdf}{VMLS Chapter 10.1 - Matrix-Matrix Multiplication}
    \item \pdflink{\ReadMatDir VMLS Chapter 10.2 - Composition Of Linear Functions.pdf}{VMLS Chapter 10.2 - Composition Of Linear Functions}
    \item \pdflink{\ReadMatDir VMLS Chapter 10.3 - Matrix Power.pdf}{VMLS Chapter 10.3 - Matrix Power}
    \item \pdflink{\ReadMatDir VMLS Chapter 10.4 - QR Factorization.pdf}{VMLS Chapter 10.4 - QR Factorization}
    \item \pdflink{\ReadMatDir Python Companion Chapter 10.1 - Matrix-Matrix Multiplication.pdf}{Python Companion Chapter 10.1 - Matrix-Matrix Multiplication}
    \item \pdflink{\ReadMatDir Python Companion Chapter 10.2 - Composition Of Linear Functions.pdf}{Python Companion Chapter 10.2 - Composition Of Linear Functions}
    \item \pdflink{\ReadMatDir Python Companion Chapter 10.3 - Matrix Power.pdf}{Python Companion Chapter 10.3 - Matrix Power}
    \item \pdflink{\ReadMatDir Python Companion Chapter 10.4 - QR Factorization.pdf}{Python Companion Chapter 10.4 - QR Factorization}
\end{itemize}
