...
\begin{itemize}
    \item \pdflink{\ReadingMatDir Chapter 5.7 - Understanding Modern Processors.pdf}{Chapter 5.7 - Understanding Modern Processors}
    \item \pdflink{\ReadingMatDir Chapter 5.8 - Loop Unrolling.pdf}{Chapter 5.8 - Loop Unrolling}
    \item \pdflink{\ReadingMatDir Chapter 5.9 - Enhancing Parallelism.pdf}{Chapter 5.9 - Enhancing Parallelism}
    \item \pdflink{\ReadingMatDir Chapter 5.10 - Summary Of Results For Optimizing Combining Code.pdf}{Chapter 5.10 - Summary Of Results For Optimizing Combining Code}
    \item \pdflink{\ReadingMatDir Chapter 5.11 - Some Limiting Factors.pdf}{Chapter 5.11 - Some Limiting Factors}
    \item \pdflink{\ReadingMatDir Chapter 5.12 - Line In The Real World - Performance Improvement Techniques.pdf}{Chapter 5.12 - Line In The Real World - Performance Improvement Techniques}
    \item \pdflink{\ReadingMatDir Chapter 5.13 - Understanding Memory Performance.pdf}{Chapter 5.13 - Understanding Memory Performance}
    \item \pdflink{\ReadingMatDir Chapter 5.14 - Identifying and Eliminating Performance Bottlenecks.pdf}{Chapter 5.14 - Identifying and Eliminating Performance Bottlenecks}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 7 - Chapter 4 & 5.pdf}{Quiz 7 - Chapter 4 \& 5}
\end{itemize}
