...
\begin{itemize}
    \item \pdflink{\ReadingMatDir Chapter 7.5 - Symbols And Symbol Tables.pdf}{Chapter 7.5 - Symbols And Symbol Tables}
    \item \pdflink{\ReadingMatDir Chapter 7.6 - Symbol Resolution.pdf}{Chapter 7.6 - Symbol Resolution}
    \item \pdflink{\ReadingMatDir Chapter 7.7 - Relocation.pdf}{Chapter 7.7 - Relocation}
    \item \pdflink{\ReadingMatDir Chapter 7.8 - Relocatable Object Files.pdf}{Chapter 7.8 - Relocatable Object Files}
    \item \pdflink{\ReadingMatDir Chapter 7.9 - Loading Executable Object Files.pdf}{Chapter 7.9 - Loading Executable Object Files}
    \item \pdflink{\ReadingMatDir Chapter 7.10 - Dynamic Linking With Shared Libraries.pdf}{Chapter 7.10 - Dynamic Linking With Shared Libraries}
    \item \pdflink{\ReadingMatDir Chapter 7.11 - Loading And Linking Shared Libraries From Applications.pdf}{Chapter 7.11 - Loading And Linking Shared Libraries From Applications}
    \item \pdflink{\ReadingMatDir Chapter 7.12 - Position-Independent Code (PIC).pdf}{Chapter 7.12 - Position-Independent Code (PIC)}
    \item \pdflink{\ReadingMatDir Chapter 7.13 - Library Interpositioning.pdf}{Chapter 7.13 - Library Interpositioning}
\end{itemize}
