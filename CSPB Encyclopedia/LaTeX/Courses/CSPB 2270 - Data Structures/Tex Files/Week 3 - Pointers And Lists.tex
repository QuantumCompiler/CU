...
\begin{itemize}
    \item \href{https://github.com/QuantumCompiler/CU/tree/main/CSPB%202270%20-%20Data%20Structures/CSPB%202270%20-%20Programming%20Assignments/CSPB%202270%20-%20Assignment%202%20-%20Linked%20List}{Programming Assignment 2 - Linked List}
    \item \pdflink{\InterviewDir Linked List Interview Notes.pdf}{Linked List Interview Notes}
\end{itemize}

\subsection{Chapter Summary}

The first chapter of this week is \pdflink{\ReadingMatDir Ch. 4 Pointers.pdf}{Chapter 4: Pointers}.
...
\begin{notes}{Section 4.1 - Why Pointers?}
    ...
    \begin{highlight}[Pointers Example]
...
\begin{notes}{Section 4.2 - Pointer Basics}
    ...
    \begin{highlight}[Pointer Basics Example]
...
\begin{notes}{Section 4.3 - Operators, new, delete, and The Member Access}
    ...
    \begin{highlight}[Pointer Operators Example]
...
\begin{notes}{Section 4.4 - String Functions With Pointers}
    ...
    \begin{highlight}[C String Functions Example]
...
\begin{notes}{Section 4.5 - A First Linked List}
    ...
    \begin{highlight}[Linked List Example]
...
\begin{notes}{Section 4.6 - Memory Regions, Heap / Stack}
    ...
    \begin{highlight}[Memory Regions Example]
...
\begin{notes}{Section 4.7 - Memory Leaks}
    ...
    \begin{highlight}[Memory Leak Example]
...
\begin{notes}{Section 4.8 - Destructor}
    ...
    \begin{highlight}[Destructors Example]
...
\begin{notes}{Section 4.9 - Copy Constructors}
    ...
    \begin{highlight}[Copy Constructor Example]
...
\begin{notes}{Section 4.10 - Copy Assignment Operator}
    ...
    \begin{highlight}[Overloading Assignment Operator Example]
...
\begin{notes}{Section 4.11 - Rule of Three}
    ...
    \begin{highlight}[Rule of Three Example]
...
The second chapter of this week is \pdflink{\ReadingMatDir Ch. 5 Lists.pdf}{Chapter 5: Lists}.
...
\begin{notes}{Section 5.1 - List Abstract Data Type (ADT)}
    ...
    \begin{highlight}[List (ADT) Example]
...
\begin{notes}{Section 5.2 - Singly-Linked Lists}
    ...
    \begin{highlight}[Singly Linked List Example]
...
\begin{notes}{Section 5.3 - List Data Structure}
...
\begin{notes}{Section 5.4 - Singly-Linked Lists: Insert}
    ...
    \begin{highlight}[Singly-Linked List Insert Example]
...
\begin{notes}{Section 5.5 - Singly-Linked Lists: Remove}
    ...
    \begin{highlight}[Singly-Linked List Remove Example]
...
\begin{notes}{Section 5.6 - Linked List Search}
    ...
    \begin{highlight}[Linked List Search Example]
...
\begin{notes}{Section 5.7 - Doubly-Linked Lists}
    ...
    \begin{highlight}[Doubly-Linked List Example]
...
\begin{notes}{Section 5.8 - Doubly-Linked Lists: Insert}
    ...
    \begin{highlight}[Doubly-Linked List Insert Example]
...
\begin{notes}{Section 5.9 - Doubly-Linked Lists: Remove}
    ...
    \begin{highlight}[Doubly-Linked List Remove Example]
...
\begin{notes}{Section 5.10 - Linked List Traversal}
    \subsubsection*{Overview}
    ...
    \begin{highlight}[Linked List Traversal Example]
...
\begin{notes}{Section 5.11 - Sorting Linked Lists}
    ...
    \begin{highlight}[Sorting a Linked List Example]
...
\begin{notes}{Section 5.12 - Linked List Dummy Nodes}
    \subsubsection*{Overview}
    ...
    \begin{highlight}[Dummy Nodes Example]
...
\begin{notes}{Section 5.13 - Linked Lists: Recursion}
    ...
    \begin{highlight}[Linked List Recursion Example]
...
\begin{notes}{Section 5.15 - Array-Based Lists}
...
\begin{notes}{Section 5.18 - Array-Based Stacks}
    ...
    \begin{highlight}[Array-Based Stack Example]
...
\begin{notes}{Section 5.20 - Queues Using Linked Lists}
...
\begin{notes}{Section 5.21 - Array-Based Queues}
    \subsubsection*{Overview}
    ...
    \begin{highlight}[Array-Based Queue Example]
