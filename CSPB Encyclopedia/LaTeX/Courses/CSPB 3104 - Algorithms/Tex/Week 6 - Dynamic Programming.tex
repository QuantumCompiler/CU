...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 15.1 - Rod Cutting.pdf}{Chapter 15.1 - Rod Cutting}
    \item \pdflink{\ReadMatDir Chapter 15.2 - Matrix-Chain Multiplication.pdf}{Chapter 15.2 - Matrix-Chain Multiplication}
    \item \pdflink{\ReadMatDir Chapter 15.3 - Elements Of Dynamic Programming.pdf}{Chapter 15.3 - Elements Of Dynamic Programming}
    \item \pdflink{\ReadMatDir Chapter 15.4 - Longest Common Subsequence.pdf}{Chapter 15.4 - Longest Common Subsequence}
    \item \pdflink{\ReadMatDir Chapter 15.5 - Optimal Binary Search Trees.pdf}{Chapter 15.5 - Optimal Binary Search Trees}
\end{itemize}
...
\begin{itemize}
    \item \href{https://github.com/QuantumCompiler/CU/tree/main/CSPB%203104%20-%20Algorithms/CSPB%203104%20-%20Assignments/CSPB%203104%20-%20Problem%20Sets/CSPB%203104%20-%20Problem%20Set%206%20-%20Dynamic%20Programming}{Problem Set 6 - Dynamic Programming}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 6.pdf}{Quiz 6}
\end{itemize}
