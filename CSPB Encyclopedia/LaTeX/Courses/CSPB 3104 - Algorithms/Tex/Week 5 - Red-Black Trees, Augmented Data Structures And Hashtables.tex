...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 11.1 - Direct-Address Tables.pdf}{Chapter 11.1 - Direct-Address Tables}
    \item \pdflink{\ReadMatDir Chapter 11.2 - Hash Tables.pdf}{Chapter 11.2 - Hash Tables}
    \item \pdflink{\ReadMatDir Chapter 11.3 - Hash Functions.pdf}{Chapter 11.3 - Hash Functions}
    \item \pdflink{\ReadMatDir Chapter 13.1 - Properties Of Red-Black Trees.pdf}{Chapter 13.1 - Properties Of Red-Black Trees}
    \item \pdflink{\ReadMatDir Chapter 13.2 - Rotations.pdf}{Chapter 13.2 - Rotations}
    \item \pdflink{\ReadMatDir Chapter 13.3 - Insertion.pdf}{Chapter 13.3 - Insertion}
    \item \pdflink{\ReadMatDir Chapter 14.1 - Dynamic Order Statistics.pdf}{Chapter 14.1 - Dynamic Order Statistics}
    \item \pdflink{\ReadMatDir Chapter 14.2 - How To Augment A Data Structure.pdf}{Chapter 14.2 - How To Augment A Data Structure}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 5.pdf}{Quiz 5}
\end{itemize}
