...
\begin{itemize}
    \item \pdflink{\ReadMatDir Chapter 8.1 - Lower Bounds For Sorting.pdf}{Chapter 8.1 - Lower Bounds For Sorting}
    \item \pdflink{\ReadMatDir Chapter 9.1 - Minimum And Maximum.pdf}{Chapter 9.1 - Minimum And Maximum}
    \item \pdflink{\ReadMatDir Chapter 9.2 - Selection In Expected Linear Time.pdf}{Chapter 9.2 - Selection In Expected Linear Time}
    \item \pdflink{\ReadMatDir Chapter 9.3 - Selection In Worst-Case Linear Time.pdf}{Chapter 9.3 - Selection In Worst-Case Linear Time}
\end{itemize}
...
\begin{itemize}
    \item \href{https://github.com/QuantumCompiler/CU/tree/main/CSPB%203104%20-%20Algorithms/CSPB%203104%20-%20Assignments/CSPB%203104%20-%20Problem%20Sets/CSPB%203104%20-%20Problem%20Set%204%20-%20Quick%20Select%20And%20Binary%20Search%20Trees}{Problem Set 4 - Quick Select And Binary Search Trees}
\end{itemize}
...
\begin{itemize}
    \item \pdflink{\QuizDir Quiz 4.pdf}{Quiz 4}
\end{itemize}
